...
FATE_DNN += fate-dnn-layer-depthwiseconv2d
fate-dnn-layer-depthwiseconv2d: $(DNNTESTSDIR)/dnn-layer-depthwiseconv2d-test$(EXESUF)
fate-dnn-layer-depthwiseconv2d: CMD = run $(DNNTESTSDIR)/dnn-layer-depthwiseconv2d-test$(EXESUF)
fate-dnn-layer-depthwiseconv2d: CMP = null
...
FATE_DNN += fate-dnn-layer-reshape
fate-dnn-layer-reshape: $(DNNTESTSDIR)/dnn-layer-reshape-test$(EXESUF)
